...
export default function NanobodyOverviewPage() {
  ...
  return <main className="mx-auto max-w-6xl space-y-12 px-6 py-12 lg:px-8">
    ...
    <section className="space-y-4"><h2 className="text-2xl font-semibold">Two generators, common scoring</h2><p className="text-lg leading-8 text-muted-foreground">AbNatiV2 VHH and HuDiff-Nb generate candidates concurrently. Native CDR masks, prepared-parent cysteines and parental IMGT 42/49/50/52 remain protected. AbNatiV2 contributes its final endpoint; HuDiff-Nb attempts can produce duplicates or invalid designs.</p><p className="leading-7 text-muted-foreground">Every unique candidate and prepared parent is evaluated with human-VH (VH2) and VHH (VHH2) nativeness models. There is no separate HuDiff quality score. Higher model scores do not demonstrate experimental benefit.</p></section>
